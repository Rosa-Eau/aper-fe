...
const BackDefault = () => {
  ...
  //Function to set The Selected Image in the field
  ...
  // Function to save Image & navigate to next page
  ...
  // Function to determine Mobile Responsiveness
      ...
      <div className="frame-bk">
        <div className="frame-group-bk">
          <div className="flex-container">
            ...
            <div className="label-button-wrapper-bk1">
              <Link className="col" to="/backgroundedit/look">
                <div className="box" onClick={handleImageClick1}>
                  <div className="label-button1-bk1 " onClick={upload}>
              ...
              <div className="frame-div-bk">
                <div className="frame-parent1-bk">
                  ...
                  <b className="title2-bk">
                    <p className="pp-bk">{getpen}</p>
                    <p className="p-bk">작가의 필드</p>
                  </b>
                  <b className="p1-bk">{getpen} 작가의 필드 커버 미리보기</b>
                </div>
          ...
          <div className="room-bk">
            <Link to="/backgroundedit/edit" className="col">
              <div >
