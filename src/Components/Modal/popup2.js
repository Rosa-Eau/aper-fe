...
const Popup2 = ({ isPopupVisible1, onCancelClick1 }) => {
    ...
    <div>
      ...
      {isPopupVisible1 && (
        <div className="modal-signup">
          <div onClick={toggleModal1} className="overlay-signup"></div>
          <div className="modal-content-signup">
              ...
              <div className="label-button-signup">
                <div className="text5-signup">
                  <div className="div26-signup">
                    <button className="custom-button-signup-1" onClick={onCancelClick1}>
                      확인
                    </button></div>
                </div>
              </div>
            ...
            <button className="close-modal-signup-1" onClick={onCancelClick1}>
              <img
